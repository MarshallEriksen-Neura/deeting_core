...
class SpecDraftRequest(BaseSchema):
    ...
    context: dict[str, Any] | None = Field(
        default=None, description="上下文补充信息"
    )
    model: str | None = Field(default=None, description="规划阶段使用的模型")
...
class SpecNodeStatus(BaseSchema):
    ...
    output_preview: str | None = Field(None, description="输出预览或错误摘要")
    pulse: str | None = Field(None, description="运行中提示文案")
...
class SpecNodeExecutionDetail(BaseSchema):
    ...
    created_at: datetime | None = Field(None, description="日志创建时间")
    started_at: datetime | None = Field(None, description="节点开始时间")
    completed_at: datetime | None = Field(None, description="节点完成时间")
    duration_ms: int | None = Field(None, description="节点耗时（毫秒）")
    input_snapshot: dict[str, Any] | None = Field(None, description="输入快照")
    output_data: dict[str, Any] | None = Field(None, description="输出数据")
    raw_response: Any | None = Field(None, description="原始响应")
    error_message: str | None = Field(None, description="错误信息")
    worker_snapshot: dict[str, Any] | None = Field(None, description="执行器快照")
    logs: list[str] = Field(default_factory=list, description="节点执行日志")
...
class SpecPlanStartResponse(BaseSchema):
    ...
    executed: int | None = Field(None, description="本次推进的节点数")
    nodes: list[str] | None = Field(None, description="相关节点列表")
...
class SpecPlanInteractRequest(BaseSchema):
    ...
    feedback: str | None = Field(None, description="用户补充意见")
