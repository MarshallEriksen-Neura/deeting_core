...
class Settings(BaseSettings):
    ...
    CODE_MODE_DIRECT_TOOL_ALLOWLIST: str = "consult_expert_network"
    ...
    MONITOR_DESKTOP_HEARTBEAT_TTL_SECONDS: int = 120
    MONITOR_LOCAL_CLAIM_LEASE_SECONDS: int = 180
    MONITOR_DESKTOP_PULL_MAX_LIMIT: int = 20
    ...
    CONVERSATION_SUMMARY_IDLE_SECONDS: int = 600
    ...
    AGENT_EXECUTOR_MAX_TURNS_EXTERNAL: int = 24
    AGENT_EXECUTOR_MAX_TURNS_INTERNAL: int = 30
    AGENT_EXECUTOR_MAX_TURNS_HARD_LIMIT: int = 60
    AGENT_EXECUTOR_TIMEOUT_EXTERNAL_SECONDS: float = 120.0
    AGENT_EXECUTOR_TIMEOUT_INTERNAL_SECONDS: float = 300.0
    AGENT_TOOL_CALL_TIMEOUT_SECONDS: float = 300.0
