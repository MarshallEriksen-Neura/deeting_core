        ...
        async with AsyncSessionLocal() as session:
            ...
            try:
                ...
                output = {
                    ...
                    "stdout": stdout_str,
                    "stderr": stderr_str,
                    "artifacts": [a.get("name") for a in artifacts] # Simplify artifact list
                }
                ...
                return {"error": f"Skill '{skill_id}' execution failed: {str(ve)}"}
            except Exception as e:
                logger.error(f"SkillRunner: Execution error: {e}", exc_info=True)
                return {"error": f"Skill execution error: {str(e)}"}
