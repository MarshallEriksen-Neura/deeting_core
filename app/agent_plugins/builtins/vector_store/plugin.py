...
class VectorStorePlugin(AgentPlugin):
    ...
    async def handle_add_knowledge_chunk(
    ...
    async def handle_search_knowledge(
        self, query: str, scope: str = "all", limit: int = 3
    ) -> str:
        """
        ...
        try:
            ...
            async def _search_personal():
                ...
                for item in items:
                    ...
                    res.append(
                        f"- [PERSONAL] [Score: {item['score']:.2f}] {content} (Meta: {meta})"
                    )
                return res
            ...
            async def _search_system():
                ...
                for item in api_results:
                    ...
                    res.append(
                        f"- [SYSTEM] [Score: {score:.2f}] {content} (Meta: {meta})"
                    )
                return res
            ...
            return f"Error processing search: {e!s}"
