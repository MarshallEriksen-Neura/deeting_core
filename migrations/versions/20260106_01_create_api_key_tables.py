...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name", sa.String(length=100), nullable=False, comment="Key 名称/描述"
        ),
        ...
        sa.Column(
            "revoked_at", sa.DateTime(timezone=True), nullable=True, comment="吊销时间"
        ),
        sa.Column(
            "revoked_reason", sa.String(length=255), nullable=True, comment="吊销原因"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=False,
            comment="范围类型: capability/model/endpoint",
        ),
        sa.Column(
            "scope_value",
    ...
    op.create_table(
        ...
        sa.Column(
            "concurrent_limit", sa.Integer(), nullable=True, comment="并发请求数限制"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=False,
            comment="配额类型: token/request/cost",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "stat_hour", sa.SmallInteger(), nullable=False, comment="统计小时 (0-23)"
        ),
        sa.Column(
            "request_count",
            sa.BigInteger(),
