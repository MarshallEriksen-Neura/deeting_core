...
down_revision: str | None = "20260115_04_create_assistant_market_tables"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_assistant_tag_link_assistant", "assistant_tag_link", ["assistant_id"]
    )
    op.create_index("ix_assistant_tag_link_tag", "assistant_tag_link", ["tag_id"])
    op.create_unique_constraint(
        "uq_assistant_tag_link", "assistant_tag_link", ["assistant_id", "tag_id"]
    )
