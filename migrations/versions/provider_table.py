...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "display_name", sa.String(length=128), nullable=False, comment="展示名称"
        ),
    ...
    op.create_index(
        "ix_public_model_model_id", "public_model", ["model_id"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "base_url", sa.String(length=255), nullable=False, comment="上游基础 URL"
        ),
        sa.Column(
            "auth_type",
            sa.String(length=20),
            nullable=False,
            comment="认证方式: api_key, bearer, none",
        ),
        sa.Column(
            "auth_config",
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("provider_preset.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "capability", sa.String(length=32), nullable=False, comment="能力类型"
        ),
        ...
        sa.Column(
            ...
            nullable=False,
            comment="请求路径（相对 base_url）",
        ),
        sa.Column(
            "template_engine",
            sa.String(length=32),
            nullable=False,
            server_default=sa.text("'simple_replace'"),
            comment="模板引擎类型",
        ),
        sa.Column(
            "request_template",
        ...
        sa.Column(
            "shared_scope", sa.String(length=32), nullable=True, comment="共享作用域"
        ),
        sa.Column(
            "shared_targets",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.UniqueConstraint(
            ...
            "model",
            "upstream_path",
            name="uq_preset_item_identity",
        ),
    )
    op.create_index(
        "ix_preset_item_lookup",
        "provider_preset_item",
        ["preset_id", "capability"],
        unique=False,
    )
    op.create_index(
        "ix_provider_preset_item_unified_model_id",
        "provider_preset_item",
        ["unified_model_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_provider_preset_item_unified_model_id", table_name="provider_preset_item"
    )
