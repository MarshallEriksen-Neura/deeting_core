...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=True,
            comment="品牌主色调 (Hex/Tailwind class)",
        ),
    )
    op.add_column(
        "provider_preset",
        sa.Column(
            ...
            sa.String(length=50),
            nullable=True,
            comment="分类 (Cloud API / Local Hosted / Custom)",
        ),
    )
    op.add_column(
        "provider_preset",
        sa.Column(
            "url_template", sa.String(length=255), nullable=True, comment="URL 模板"
        ),
    )
    ...
    op.add_column(
        "provider_instance",
        sa.Column(
            "description", sa.String(length=255), nullable=True, comment="实例描述"
        ),
    )
