...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_provider_instance_user", "provider_instance", ["user_id"], unique=False
    )
    op.create_index(
        "ix_provider_instance_preset_slug",
        "provider_instance",
        ["preset_slug"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_provider_model_model_id", "provider_model", ["model_id"], unique=False
    )
