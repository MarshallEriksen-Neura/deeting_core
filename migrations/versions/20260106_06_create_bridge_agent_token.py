...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "version", sa.Integer(), nullable=False, comment="当前有效版本，单活"
        ),
        sa.Column(
            "issued_at", sa.DateTime(timezone=True), nullable=False, comment="签发时间"
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_bridge_agent_token_user_id"),
        "bridge_agent_token",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bridge_agent_token_agent_id"),
        "bridge_agent_token",
        ["agent_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_bridge_agent_token_agent_id"), table_name="bridge_agent_token"
    )
    op.drop_index(
        op.f("ix_bridge_agent_token_user_id"), table_name="bridge_agent_token"
    )
