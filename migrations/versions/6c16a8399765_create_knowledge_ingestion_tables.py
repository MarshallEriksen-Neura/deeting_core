...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source_url", sa.String(length=1024), nullable=False, comment="来源 URL"
        ),
        sa.Column("title", sa.String(length=255), nullable=True, comment="网页标题"),
        sa.Column(
            "raw_content", sa.Text(), nullable=False, comment="原始爬取内容 (Markdown)"
        ),
        sa.Column(
            "content_hash",
            sa.String(length=64),
    ...
    op.create_index(
        "ix_knowledge_artifact_source_url",
        "knowledge_artifact",
        ["source_url"],
        unique=True,
    )
    op.create_index(
        "ix_knowledge_artifact_status", "knowledge_artifact", ["status"], unique=False
    )
    op.create_index(
        "ix_knowledge_artifact_type",
        "knowledge_artifact",
        ["artifact_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "chunk_index", sa.Integer(), nullable=False, comment="在原文中的顺序索引"
        ),
        sa.Column(
            "text_content", sa.Text(), nullable=False, comment="清洗后的切片文本"
        ),
        sa.Column(
            "metadata_summary",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_knowledge_chunk_artifact_id_knowledge_artifact"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_knowledge_chunk")),
    )
    op.create_index(
        "ix_knowledge_chunk_artifact_id",
        "knowledge_chunk",
        ["artifact_id"],
        unique=False,
    )
